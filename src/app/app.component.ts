...
export class AppComponent{
  ...
  public test(){
    ...
    Promise.all([
      ...
      scatterPlot.ScatterPlot(files[2], files[1], 17, "#ScatterPlot2")
      scatterPlot.ScatterPlot(files[2], files[1], 18, "#ScatterPlot3")
      scatterPlot.ScatterPlot(files[2], files[1], 19, "#ScatterPlot4")
      scatterPlot.ScatterPlot(files[2], files[1], 20, "#ScatterPlot5")
      scatterPlot.ScatterPlot(files[2], files[1], 21, "#ScatterPlot6")
      scatterPlot.ScatterPlot(files[2], files[1], 22, "#ScatterPlot7")
      scatterPlot.ScatterPlot(files[2], files[1], 23, "#ScatterPlot8")
    }).catch(function(err) {
      // handle error here
    })
  }
